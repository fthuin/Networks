...
\title{LINGI1341 Computer Networks : Information transfer}
\author{Nicolas Houtain\and Benoît Legat\and Gorby Nicolas Ndonda Kabasele\and Florian Thuin}

\graphicspath{{images/}}
\lstset{inputpath=algorithm, keepspaces=true, morekeywords={isin, each}, keywordstyle=\color{red!70}, commentstyle=\color{blue!60}, breaklines=true}
...
The different layers are represented par le tableau layers.
...
\begin{enumerate}
    ...
    \item Pour rendre le protocole reliable, on utilise un numéro de séquence 
        ...
        $\to$ 32 ou 64 bits nécessaire (pour detecter les délais et parce que les numéros s'usent plus vite) plutot que 
...
\multicolumn{2}{p{15cm}}{220 : service ready, 221 : connection close, 250 : action okay, 354 : start mail, 3xx : need more information, 5xx : error}
\end{tabular}
...
\section{Algorithmes}
   \subsection{MAC Address Learning par les switches}
	  ...
	  \framebox{\begin{minipage}{\linewidth}
	     ...
	     %\listinginput[1]{1}{algorithm/mac_address_learning.py}
	     % TODO : Trouver un joli environnement pour le code
	  \end{minipage}}
	  \end{center}
